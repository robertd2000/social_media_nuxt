  ...
  <div>
    ...
    <div class="icons">
      <div class="icons-wrapper">
        <div class="icon" @click="handleImageClick">
...
.header {
  @apply flex items-center flex-shrink-0 p-4 pb-0;
  ...
  .input {
    ...
    > textarea {
      @apply w-full h-10 text-lg text-gray-900 placeholder:text-gray-400 bg-transparent border-0 dark:text-white focus:ring-0;
    }
  }
}
...
.icons {
  @apply flex p-2 pl-14;

  .icons-wrapper {
    @apply flex w-full text-white;

    .icon {
      @apply p-2 text-blue-400 rounded-full cursor-pointer hover:bg-blue-50 dark:hover:bg-dim-800;
